...
public class View_student extends JFrame implements ActionListener {
    ...
    View_student(){
        ...
        try {
            ...
            String query1="select count(roll_no) from student";
            ...
            int i=0,j=0;
            String query2="select roll_no, name, email, course, fee, paid, due, address, city, state, country, contact from student";
